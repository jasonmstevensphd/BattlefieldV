...
The purpose of this project is to analyze my play style and identify ways to improve. The  data for this experiment comes from manual entering values after each match. The critical factors are date, map, gamemode, offense/neutral/defense, class, weapon, assignment, assignment type, practice range, full game, win, game score, kills and deaths. Additionally it will be interesting to construct models based on metrics for maps and weapons that could be used to predict how well I might play with a new weapon or on a new map as the Tides of War continue.
